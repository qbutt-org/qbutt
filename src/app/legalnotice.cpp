...
void showLegalNotice(const bool isInteractive)
{
    ...
    const QString noticeBody = QCoreApplication::translate("LegalNotice", "qbutt is a file sharing program. When you run a torrent, its data will be made available to others by means of upload. Any content you share is your sole responsibility.");
