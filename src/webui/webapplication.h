...
private:
    ...
    const QHash<std::pair<QString, QString>, QString> m_allowedMethod =
    {
        ...
        {{u"qbuttPaths"_s, u"list"_s}, Http::METHOD_POST},
        {{u"qbuttPaths"_s, u"refresh"_s}, Http::METHOD_POST},
        ...
        {{u"qbuttRepair"_s, u"prepare"_s}, Http::METHOD_POST},
        {{u"qbuttRepair"_s, u"commit"_s}, Http::METHOD_POST},
        {{u"qbuttRepair"_s, u"rollback"_s}, Http::METHOD_POST},
